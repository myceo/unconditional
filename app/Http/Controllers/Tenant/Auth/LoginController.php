    ...
    */
    ...
    public function completeSocial(){
       ...
       // $member = $user;
        ...
        return view('auth.social.form',compact('name','user'));
    }
    ...
    public function saveSocial(Request $request){
        ...
        if(isset($requestData['date_of_birth']) && !empty($requestData['date_of_birth'])){

            $requestData['date_of_birth'] = Carbon::parse($requestData['date_of_birth'])->toDateString();
        }
        else{
            $requestData['date_of_birth'] =  null;
        }

        if(isset($requestData['wedding_anniversary']) && !empty($requestData['wedding_anniversary'])){
            $requestData['wedding_anniversary'] = Carbon::parse($requestData['wedding_anniversary'])->toDateString();
        }
        else{
            $requestData['wedding_anniversary'] = null;
        }
