...
class MembersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('picture')){
           // @unlink($member->picture);
            ...
            if(!empty($member->picture) && Storage::has($member->picture)) Storage::delete($member->picture);
    ...
    public function destroy($id)
    {
        ...
        $user = User::find($id);
        if(!empty($user->is_billing)){
            return redirect('admin/members')->with('flash_message',__('admin.billing-no-delete'));
        }
