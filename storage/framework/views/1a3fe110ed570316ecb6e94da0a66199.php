...
<html lang="en">
	...
	<head>
		...
		<meta name="keywords" content="Creative, Digital Product">	
		<meta name="viewport" content="width=device-width, initial-scale=1">
				
  		<!-- SITE TITLE -->
		<title>Software, App, SaaS & Startup Landing Pages Pack</title>
							
		<!-- FAVICON AND TOUCH ICONS -->
		<link rel="shortcut icon" href="<?php echo e(asset('themes/front/images/favicon.ico')); ?>" type="image/x-icon">
		<link rel="icon" href="<?php echo e(asset('themes/front/images/favicon.ico')); ?>" type="image/x-icon">
		<link rel="apple-touch-icon" sizes="152x152" href="<?php echo e(asset('themes/front/images/apple-touch-icon-152x152.png')); ?>">
		<link rel="apple-touch-icon" sizes="120x120" href="<?php echo e(asset('themes/front/images/apple-touch-icon-120x120.png')); ?>">
		<link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('themes/front/images/apple-touch-icon-76x76.png')); ?>">
		<link rel="apple-touch-icon" href="<?php echo e(asset('themes/front/images/apple-touch-icon.png')); ?>">
		<link rel="icon" href="<?php echo e(asset('themes/front/images/apple-touch-icon.png')); ?>" type="image/x-icon">
		...
		<!-- BOOTSTRAP CSS -->
		<link href="<?php echo e(asset('themes/front/css/bootstrap.min.css')); ?>" rel="stylesheet">
				
		<!-- FONT ICONS -->
		<link href="<?php echo e(asset('themes/front/css/flaticon.css')); ?>" rel="stylesheet">

		<!-- PLUGINS STYLESHEET -->
		<link href="<?php echo e(asset('themes/front/css/menu.css')); ?>" rel="stylesheet">	
		<link id="effect" href="<?php echo e(asset('themes/front/css/dropdown-effects/fade-down.css')); ?>" media="all" rel="stylesheet">
		<link href="<?php echo e(asset('themes/front/css/magnific-popup.css')); ?>" rel="stylesheet">	
		<link href="<?php echo e(asset('themes/front/css/owl.carousel.min.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('themes/front/css/owl.theme.default.min.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('themes/front/css/lunar.css')); ?>" rel="stylesheet">

		<!-- ON SCROLL ANIMATION -->
		<link href="<?php echo e(asset('themes/front/css/animate.css')); ?>" rel="stylesheet">

		<!-- TEMPLATE CSS -->
		<!-- <link href="css/blue-theme.css" rel="stylesheet"> -->
		<link href="<?php echo e(asset('themes/front/css/crocus-theme.css')); ?>" rel="stylesheet">
		...
		<!-- RESPONSIVE CSS -->
		<link href="<?php echo e(asset('themes/front/css/responsive.css')); ?>" rel="stylesheet">
	...
	<body class="theme--dark"> 
		...
		<div id="page" class="page font--jakarta">
			...
			<header id="header" class="tra-menu navbar-dark light-hero-header white-scroll">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">	  	
				    	<span class="smllogo"><img src="<?php echo e(asset('themes/front/images/logo-purple-white.png')); ?>" alt="mobile-logo"></span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="#hero-19" class="logo-black"><img src="<?php echo e(asset('themes/front/images/logo-purple.png')); ?>" alt="logo"></a>
	    					</div>


	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="#hero-19" class="logo-white"><img src="<?php echo e(asset('themes/front/images/logo-purple-white.png')); ?>" alt="logo"></a>
	    					</div>
			...
			<!-- HERO-19
			============================================= -->	
			<section id="hero-19" class="bg--fixed hero-section">
						...
						<div class="col-md-10 col-lg-9">
							<div class="hero-19-txt">
								...
								<div class="btns-group">
									...
									<a href="https://www.youtube.com/embed/SZEflIVnhH8" class="video-popup1 btn r-04 btn--tra-black hover--theme ico-20 ico-right">See how it works <span class="flaticon-play"></span>
									</a> 
								</div>	
		...
		<div class="col text-center">	
			<div class="owl-carousel brands-carousel-6">
				...
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-1-white.png')); ?>" alt="brand-logo"></a>
				</div>

									
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-3-white.png')); ?>" alt="brand-logo"></a>
				</div>

									
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-4-white.png')); ?>" alt="brand-logo"></a>
				</div>

									
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-5-white.png')); ?>" alt="brand-logo"></a>
				</div>

									
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-6-white.png')); ?>" alt="brand-logo"></a>
				</div>

									
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-7-white.png')); ?>" alt="brand-logo"></a>
				</div>


				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-8-white.png')); ?>" alt="brand-logo"></a>
				</div>

											
				<!-- BRAND LOGO IMAGE -->
				<div class="brand-logo">
					<a href="#"><img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-9-white.png')); ?>" alt="brand-logo"></a>
				</div>
...
<div class="row">
	<div class="col">
		<div class="hero-19-img wow fadeInUp">
			<img class="img-fluid" src="<?php echo e(asset('themes/front/images/dashboard-09.png')); ?>" alt="hero-image">	
		</div>
	</div>	
</div>	<!-- END HERO IMAGE -->
						...
						<div class="row justify-content-md-center row-cols-1 row-cols-md-3">
							...
							<div class="col">
								<div id="rb-1-1" class="rbox-1">
									...
									<div class="rbox-1-img">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-21-white.png')); ?>" alt="feature-image">
									</div>
							...
							<div class="col">
								<div id="rb-1-2" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-22-white.png')); ?>" alt="feature-image">
									</div>
							...
							<div class="col">
								<div id="rb-1-3" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/brand-23-white.png')); ?>" alt="feature-image">
									</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-07-dark.png')); ?>" alt="content-image">
							</div>
						</div>
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-6 order-first order-md-2">
									<div class="img-block right-column wow fadeInLeft">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-09.png')); ?>" alt="content-image">
									</div>
								</div>
			...
			<section id="lnk-2" class="py-100 ct-01 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-05.png')); ?>" alt="content-image">
							</div>
						</div>
			...
			<section class="bg--white-400 py-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-08.png')); ?>" alt="content-image">
							</div>
						</div>
							...
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="txt-block-tra-link mt-25">
									<a href="#features-5" class="tra-link ico-20 color--theme">
										Engagement analytics <span class="flaticon-next"></span>
									</a>
								</div>
			...
			<section class="pt-100 ct-01 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-02.png')); ?>" alt="content-image">
							</div>
						</div>
							...
							<!-- FEATURE BOX #1 -->
		 					<div class="col">
		 						<div class="fbox-2 fb-1 wow fadeInUp">
									...
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_04_dark.png')); ?>" alt="feature-image">
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-2 fb-2 wow fadeInUp">
		 							...
		 							<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_09_dark.png')); ?>" alt="feature-image">
									</div>

									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="s-22 w-700">Extremely Flexible</h6>
		 					...
		 					<div class="col">
		 						<div class="fbox-2 fb-3 wow fadeInUp">
		 							...
		 							<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_01_dark.png')); ?>" alt="feature-image">
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-2 fb-4 wow fadeInUp">
		 							...
		 							<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_05_dark.png')); ?>" alt="feature-image">
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-2 fb-5 wow fadeInUp">
		 							...
		 							<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_02_dark.png')); ?>" alt="feature-image">
									</div>

									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="s-22 w-700">Detailed Analytics</h6>
										<p>Tempor laoreet augue undo ultrice aliquam in lacusq luctus feugiat</p>
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-2 fb-6 wow fadeInUp">
		 							...
		 							<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-170">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_11_dark.png')); ?>" alt="feature-image">
									</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block wow fadeInLeft">
								<img class="img-fluid" src="<?php echo e(asset('themes/front/images/tablet-01.png')); ?>" alt="content-image">
							</div>	
						</div>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-1 bg--02 r-16 wow fadeInUp">
									...
									<div class="fbox-5-img order-first order-md-2">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_06_dark.png')); ?>" alt="feature-image">
									</div>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-2 gr--smoke r-16 wow fadeInUp">
									...
									<div class="fbox-5-img">
										<img class="img-fluid" src="<?php echo e(asset('themes/front/images/f_07_dark.png')); ?>" alt="feature-image">
									</div>
					...
					<div class="row">	
						<div class="col">
							<div class="img-block wow fadeInUp">
			 					<img class="img-fluid" src="<?php echo e(asset('themes/front/images/img-19.png')); ?>" alt="video-preview">
							</div>
						</div>
					</div>
							...
							<!-- TOOL #1 -->
		 						...
		 						<a href="#" class="in_tool it-1 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-1.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-2 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-2.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-3 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-3.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-4 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-4.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-5 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-5.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-6 r-12 mb-30 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-6.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-7 r-12 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-7.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-8 r-12 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-8.png')); ?>" alt="brand-logo">
										</div>
									</div>
		 					...
		 					<div class="col">
		 						<a href="#" class="in_tool it-9 r-12 wow fadeInUp">
		 							...
		 							<div class="in_tool-logo-wrap">
		 								<div class="in_tool-logo ico-60">
											<img class="img-fluid" src="<?php echo e(asset('themes/front/images/png_icons/tool-9.png')); ?>" alt="brand-logo">
										</div>
									</div>
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-1.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-2.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-3.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-4.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-5.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-6.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-7.jpg')); ?>" alt="review-avatar">
											</div>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<div class="author-data clearfix">
											...
											<!-- Avatar -->
											<div class="review-avatar">
												<img src="<?php echo e(asset('themes/front/images/review-author-8.jpg')); ?>" alt="review-avatar">
											</div>
			        ...
			        <div class="modal-content">
			            ...
			            <div class="modal-body text-center">
		            		...
		            		<div class="modal-body-img">
		            			<img class="img-fluid" src="<?php echo e(asset('themes/front/images/modal-newsletter-blue.jpg')); ?>" alt="content-image">
		            		</div>
					...
					<div class="row">
						...
						<div class="col-xl-3">
							<div class="footer-info">
								<img class="footer-logo" src="<?php echo e(asset('themes/front/images/logo-purple-white.png')); ?>" alt="footer-logo">
							</div>	
						</div>	
		...
		<!-- EXTERNAL SCRIPTS
		============================================= -->	
		<script src="<?php echo e(asset('themes/front/js/jquery-3.7.0.min.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/bootstrap.min.js')); ?>"></script>	
		<script src="<?php echo e(asset('themes/front/js/modernizr.custom.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/jquery.easing.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/jquery.appear.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/menu.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/owl.carousel.min.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/pricing-toggle.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/jquery.magnific-popup.min.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/request-form.js')); ?>"></script>	
		<script src="<?php echo e(asset('themes/front/js/jquery.validate.min.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/jquery.ajaxchimp.min.js')); ?>"></script>	
		<script src="<?php echo e(asset('themes/front/js/popper.min.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/lunar.js')); ?>"></script>
		<script src="<?php echo e(asset('themes/front/js/wow.js')); ?>"></script>
				
		<!-- Custom Script -->		
		<script src="<?php echo e(asset('themes/front/js/custom.js')); ?>"></script>
...
</html><?php /**PATH /home/unconditional/htdocs/unconditional.org/resources/views/home.blade.php ENDPATH**/ ?>