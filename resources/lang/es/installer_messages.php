...
return [
    ...
    'environment' => [
        ...
        'wizard' => [
            ...
            'form' => [
                ...
                'app_log_level_label' => 'Nivel de registro de aplicaciones',
                ...
                'app_tabs' => [
                    ...
                    'pusher_app_id_label' => 'ID de la aplicación de empuje',
                    'pusher_app_id_palceholder' => 'ID de la aplicación de empuje',
    ...
    'install' => 'Instalar',
    'installed' => [
        'success_log_message' => 'El instalador de GForce se INSTALÓ exitosamente en',
    ],
    'final' => [
    ...
    'updater' => [
        ...
        'log' => [
            'success_message' => 'Instalador de GForce ACTUALIZADO exitosamente el',
        ],
    ],
];