...
@section('breadcrumb')
    ...
    <li><a href="{{ route('emails.inbox') }}">@lang('admin.inbox')</a>
    </li>
                        ...
                        <div class="ticket-form">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a href="{{ url('admin/emails/create') }}?reply={{ $email->id }}" class="btn btn-primary"><i class="fa fa-reply"></i> @lang('admin.reply')</a>
                                        <button onclick="printPageArea('mailContent')" class="btn btn-success"><i class="fa fa-print"></i> @lang('admin.print')</button>

                                        <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-danger" href="{{ route('email.delete-inbox',['id'=>$email->id]) }}"><i class="fa fa-trash"></i> @lang('admin.delete')</a>
