...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/member/sms') }}">@lang('admin.sent-sms')</a>
    </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        ...
                        <ul class="nav nav-pills" id="myTab2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile" aria-selected="false">@lang('admin.recipients'):  ({{ $sms->users()->count() }})</a>
                            </li>
                                ...
                                <div class="card" id="mailContent">
                                    ...
                                    <div class="card-footer">
                                        <div class="btn-group float-right">
                                            ...
                                            <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-danger" href="{{ route('member.sms.delete',['id'=>$sms->id]) }}"><i class="fa fa-trash"></i> @lang('admin.delete')</a>
                                        </div>
                                    </div>
