...
@section('content')
    ...
    <div class="card">
        ...
        <form id="msg-list" action="{{ route('member.sms.delete-multiple-inbox') }}" onsubmit="return confirm('@lang('admin.delete-prompt')')" method="post">
            @csrf
                    ...
                    <table class="table">
                        ...
                        @foreach($sms as $item)
                            <tr @if($item->pivot->read==0) class="unread" @endif >
                                ...
                                <td>
                                    <a  href="{{ route('member.sms.delete-inbox',['id'=>$item->id]) }}"  title="@lang('site.delete')" onclick="return confirm('@lang('admin.delete-prompt')')" ><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody></table>
