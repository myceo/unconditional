...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('member.courses') }}">@lang('site.courses')</a></li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <a href="{{ route('member.course-enroll',['course'=>$course->id]) }}" class="btn btn-success btn-block mt-3"><i class="fa fa-user-plus"></i> @lang('site.enroll')</a>
