        ...
        <div class="modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('member.courses') }}" method="get">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('member.courses') }}" class="btn btn-secondary">@lang('site.reset')</a>
    ...
    <div class="row mt-3">
        @foreach($courses as $course)
            <div class="col-md-4 mb-4" style="position: relative">
                ...
                <div class="card">
                    <!-- Card image -->
                    <a href="{{ route('member.course-details',['course'=>$course->id]) }}"><img class="card-img-top" src="{{ asset(!empty($course->picture)?$course->picture:'img/no_image.jpg') }}" ></a>
                    <!-- Card body -->
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('member.course-enroll',['course'=>$course->id]) }}" class="btn btn-success btn-block"><i class="fa fa-user-plus"></i> @lang('site.enroll')</a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('member.course-details',['course'=>$course->id]) }}" class="btn btn-primary btn-block"><i class="fa fa-info-circle"></i> @lang('site.details')</a>
                            </div>
                        </div>
