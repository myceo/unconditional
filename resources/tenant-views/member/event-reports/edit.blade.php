...
@section('pageTitle',__('admin.edit').' '.__('admin.report').' : '.$eventreport->event->name)
@section('innerTitle',__('admin.edit').' '.__('admin.report').' : '.$eventreport->event->name)
@php
...
@section('breadcrumb')
    ...
    <li><a href="{{ $backRoute }}">@lang('admin.event-reports')</a>
    </li>
    <li><span>{{ __('site.edit').' '.__('admin.report') }}</span>
    </li>
@endsection
@section('content')
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div  >
                    <div  >
                        <a href="{{ $backRoute }}" title="@lang('admin.back')"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> @lang('admin.back')</button></a>
                        <br />
                        <br />



                        <form method="POST" action="{{ url('/member/event-reports/' . $eventreport->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            @include ('member.event-reports.form', ['formMode' => 'edit'])
