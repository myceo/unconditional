...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/member/emails') }}">@lang('admin.sent-messages')</a>
    </li>
                                ...
                                <div class="ticket-form">
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-danger" href="{{ route('member.email.delete',['id'=>$email->id]) }}"><i class="fa fa-trash"></i> @lang('admin.delete')</a>
